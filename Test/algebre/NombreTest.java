...
public class NombreTest {
    ...
    public void testAdd(){
        ...
        Ratio r1 = (Ratio) p8_3.add(n4_5); // ca fait 28/15
        Ratio r2 = (Ratio) n4_5.add(p8_3); // ca fait 28 / 15  aussi
        Ratio r3 = (Ratio) p1_4.add(n3_4); // ca fait -1/2
        Ratio r4 = (Ratio) n3_4.add(p1_4); // ca fait -1/2 aussi
    ...
    @Test
    public void TestTypage(){
        //On verifie que toute operation entre Reel et Rationnel est impossible

        Nombre m1 = new Ratio(7, 8);
        Nombre r1 = new Reel(4.5);


        assertThrows(ArithmeticException.class, ()-> m1.add(r1) );
        assertThrows(ArithmeticException.class, ()-> m1.neg(r1) );
        assertThrows(ArithmeticException.class, ()-> m1.mul(r1) );
        assertThrows(ArithmeticException.class, ()-> m1.div(r1));


        assertThrows(ArithmeticException.class, ()-> r1.add(m1) );
        assertThrows(ArithmeticException.class, ()-> r1.neg(m1) );
        assertThrows(ArithmeticException.class, ()-> r1.mul(m1) );
        assertThrows(ArithmeticException.class, ()-> r1.div(m1) );
    }
